...
void VulkanEngine::init_vulkan()
{
    ...
    auto inst_ret = builder.set_app_name("Vulk App")
    ...
    //grab out the bootstrap vals into vulkan
    ...
    while (!bQuit) {
        ...
        while (SDL_PollEvent(&e) != 0) {
            ...
            if (e.type == SDL_KEYDOWN) {
                fmt::println("{} Pressed", e.key.keysym.sym);
            }
        }
...
{
    //destroies images it holds internally - NOT THE VIEWS
